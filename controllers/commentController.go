...
func (o *CommentRepository) UploadComment(c *gin.Context) {
...
func (o *CommentRepository) GetComment(c *gin.Context) {
...
func (o *CommentRepository) UpdateComment(c *gin.Context) {
	contentType := helpers.GetContentType(c)
	Comment := models.Comment{}
...
func (o *CommentRepository) DeleteComment(c *gin.Context) {
	getId, _ := strconv.Atoi(c.Param("commentId"))
